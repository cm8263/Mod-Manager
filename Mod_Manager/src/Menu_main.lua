...
-- Mod Manager Requires
require("Mod_Manager.lua")
...
Menu_Main = function()
  ...
  menu.Populate = function(self)
    ...
    Menu_Add(ListButtonLite, "modManagerSpacerMenuMain", "")
    Menu_Add(ListButtonLite, "modManager", "Mod Manager", "Mod_Manager_Load()")
